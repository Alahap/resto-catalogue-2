...
// import { createRestaurantNameList } from '../templates/template-creator';
...
const Home = {
  async render() {
    return `
        ...
        <div id="restaurant_name_list" class="restaurant_name_list"></div>
        <section class="post">
...
//     const restaurantContainer = document.querySelector('#restaurant_name_list');
//     restaurants.forEach((restaurant) => {
//       restaurantContainer.innerHTML += createRestaurantNameList(restaurant);
//     });
//   },
